...
```bash
node "/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/get-shit-done/bin/gsd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
