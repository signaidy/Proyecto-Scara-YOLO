...
- **Global scope**: `/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/notes/`)
...
2. Glob `/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/notes/` — works in any directory
