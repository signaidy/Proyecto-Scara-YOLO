...
PHASES=$(node "/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/get-shit-done/bin/gsd-tools.cjs" phases list)
...
```bash
node "/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
