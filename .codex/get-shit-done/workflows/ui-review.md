...
```bash
UI_AUDITOR_MODEL=$(node "/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-ui-auditor --raw)
```
...
```markdown
Read /mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/agents/gsd-ui-auditor.md for instructions.
...
```bash
node "/mnt/c/Users/comsi/Documents/src/Robotica/Proyecto/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
